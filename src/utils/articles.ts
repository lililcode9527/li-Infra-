...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    title: 'MoeDistributeDispatchV2 算子深度解析：通算融合架构、RDMA 全互联与双缓冲同步机制',
    description:
      '深入剖析昇腾 NPU 上 MoeDistributeDispatchV2 算子的 AIV+AICPU 融合架构、FullMesh/Layered 双路径实现、RDMA 全互联通信、Token 重排与索引计算、双缓冲轮转机制、弹性伸缩及量化模式，揭示 MoE 专家并行推理通信优化的核心机制。',
    tags: ['MoeDistributeDispatchV2', 'MoE', 'EP', 'RDMA', '通算融合', 'Ascend', '双缓冲', 'FullMesh', 'Layered'],
    date: '2026-05-30',
    readingTime: 50,
  ...
  },
  {
    ...
    title: 'MoeDistributeCombineV2 算子深度解析：通算融合回收机制、Staggered Send 与双缓冲同步',
    description:
      '深入剖析昇腾 NPU 上 MoeDistributeCombineV2 算子的逆向 AllToAll 回收流程、Staggered Send 无竞争写入、通信量化反量化、Layered RDMA+IPC 架构、弹性伸缩及完整参数体系，揭示 MoE 推理闭环回收端的核心优化机制。',
    tags: ['CombineV2', 'MoE', 'AllToAllV', '加权求和', 'Ascend', 'Staggered Send', 'Layered', '双缓冲'],
    date: '2026-05-30',
    readingTime: 45,
