...
1. [GLM 系列演进总览](#1-glm-系列演进总览)
2. [GLM-5 架构总览](#2-glm-5-架构总览)
3. [GLM-4.x MoE 架构](#3-glm-4x-moe-架构)
4. [GLM-4.7-Flash](#4-glm-47-flash)
5. [DSA 稀疏注意力](#5-dsa-稀疏注意力)
6. [Rotary 量化](#6-rotary-量化)
7. [MTP 推测解码](#7-mtp-推测解码)
8. [工具调用与推理](#8-工具调用与推理)
9. [量化方案](#9-量化方案)
10. [Ascend 计算优化](#10-ascend-计算优化)
11. [Ascend 通信优化](#11-ascend-通信优化)
12. [MoE 深度优化](#12-moe-深度优化)
13. [EPLB 负载均衡](#13-eplb-负载均衡)
14. [SFA 稀疏注意力](#14-sfa-稀疏注意力)
15. [多模态扩展](#15-多模态扩展)
16. [部署配置参考](#16-部署配置参考)
17. [性能优化总结](#17-性能优化总结)
18. [关键文件索引](#18-关键文件索引)
